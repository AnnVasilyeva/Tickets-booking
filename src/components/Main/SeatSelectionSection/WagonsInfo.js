  ...
  const WagonSeatsInfo = ({classType, wagon}) => {
    if(classType == ('first' || 'fourth')) {
      return (   
        <tr>          
          <td></td>
          <td className='wagon-seat-price'>2020<img src='/images/icon-value.png' alt='icon price' width='14' height='17'/></td>
    ...
    if (classType == ('second' || 'third')) {
      return (
        ...
        <tr>
          ...
          <td className='wagon-seat-price'>3030<img src='/images/icon-value.png' alt='icon price' width='14' height='17'/></td>
          <td></td>
        </tr>
      </>
      )
      ...
      <main>
        ...
        <li key={wagon.id} className='wagons-list-item'>
          ...
          <div className='wagon-picture'>
            <img src='/images/wagon-picture.png' alt='wagon seats'/>
          </div>
        </li>
        )}
        </ul>
